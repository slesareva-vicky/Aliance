...
<html lang="ru">
  ...
  <body class="front-page">
    <!-- 
    <body class="front-page">
    <body class="front-page" style="position: relative">
    <div style="opacity: 0.7; opacity: 0.5; position: absolute; z-index: 15">
      <img src="375/main_375.png" alt="" />      
    </div>    
    <div style="opacity: 0.7; opacity: 0.5; position: fixed; z-index: 15">      
      <img src="375/phone_popup_375.png" alt="" />
    </div>
  -->
    <div class="mobile-menu">
      ...
      <a href="tel:+79596861014" class="mobile-phone">+7 (959) 686-10-14</a>
      ...
      <div class="container">
        <div class="header-content">
          ...
          <h1 class="header-title">
            Комплексное обеспечение товарами <br />и&nbsp;расходными материалами
            бизнеса
          </h1>
          <p class="header-text">
        ...
        <div class="swiper header-features-slider">
          ...
          <ul class="swiper-wrapper header-features">
            ...
            <li class="swiper-slide header-features-item">
              <svg class="header-features-icon">
          ...
          <div class="header-features-buttons transparent-buttons-wrapper">
            <div class="header-features-button-prev transparent-button-prev">
              <svg>
                <use href="img/sprite.svg#arrow-prev"></use>
              </svg>
            </div>
            <div class="header-features-button-next transparent-button-next">
              <svg>
        ...
        <div class="cards">
          <a href="#" class="card">
            <div class="card-content">
              <h3 class="card-title dark">Автомобильная химия</h3>
              <p class="card-text">
                Безусловно, сплочённость команды профессионалов позволяет
                оценить значение форм воздействия.
              </p>
          ...
          <a href="#" class="card">
            <div class="card-content">
              <h3 class="card-title dark">Бытовая химия</h3>
              <p class="card-text">
                А также стремящиеся вытеснить традиционное производство,
                нанотехнологии функционально разнесены на независимые элементы.
              </p>
          ...
          <a href="#" class="card">
            <div class="card-content">
              <h3 class="card-title dark">Дезинфицирующие средства</h3>
              <p class="card-text">
                Лишь интерактивные прототипы призваны к ответу.
              </p>
            </div>
          ...
          <a href="#" class="card">
            <div class="card-content">
              <h3 class="card-title dark">Пищевые аэрозоли</h3>
              <p class="card-text">
                Безусловно, сплочённость команды профессионалов позволяет
                оценить значение форм воздействия.
              </p>
          ...
          <a href="#" class="card">
            <div class="card-content">
              <h3 class="card-title dark">Косметическая продукция</h3>
              <p class="card-text">
                Лишь интерактивные прототипы призваны к ответу.
              </p>
            </div>
          ...
          <a href="#" class="card">
            <div class="card-content">
              <h3 class="card-title dark">Краски аэрозольные</h3>
              <p class="card-text">
                А также стремящиеся вытеснить традиционное производство,
                нанотехнологии функционально разнесены на независимые элементы.
              </p>
    ...
    <section class="section trademark">
      <div class="container">
        ...
        <h2 class="section-title">
          Собственные
          <span class="trademark-title-desktop">торговые </span> марки
        </h2>
        <div class="trademark-cards">
          <a href="#" class="trademark-card">
            ...
            <h3 class="trademark-card-title dark">Автохимия AG-Tech</h3>
          ...
          <a href="#" class="trademark-card">
            ...
            <h3 class="trademark-card-title dark">Автохимия AP</h3>
            <p class="trademark-card-text">
              Для современного мира разбавленное изрядной долей эмпатии,
              рациональное мышление создаёт предпосылки для поставленных
              обществом задач.
        ...
        <div class="founder-content-wrapper">
          <div class="founder-content">
            ...
            <div class="founder-text">
              <p class="founder-text-paragraph">
            ...
            <a href="#" class="button-link founder-button-link-mobile">
              О нашей миссии
            </a>
          </div>
        </div>
      ...
      <div class="container">
        ...
        <div class="clients-wrapper">
          ...
          <div class="clients-logo-list">
            ...
            <a href="#" class="clients-logo-item not-paired">
              <img
                src="img/client.png"
                alt="logo clients"
                class="clients-logo"
          ...
          <div class="swiper-wrapper blog-wrapper">
            ...
            <a href="#" class="swiper-slide blog-card">
              <img
                ...
                class="blog-card-image"
              />
              <h3 class="blog-card-title">Нечто о чем-то</h3>
              <p class="blog-card-text">
                Действия представителей оппозиции, превозмогая сложившуюся
                непростую экономическую ситуацию, в равной степени
                предоставлены...
